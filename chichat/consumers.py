...
class ChatroomConsumer(WebsocketConsumer):
    ...
    def message_handler(self, event):
        ...
        html = render_to_string("chichat/partials/chat_message_p.html", context=context)
    ...
    def online_count_handler(self, event):
        ...
        html = render_to_string("chichat/partials/online_count.html", context)
        self.send(text_data=html) 
...
class OnlineStatusConsumer(WebsocketConsumer):
    ...
    def online_status_handler(self, event):
        ...
        public_chat_users = ChatGroup.objects.get(group_name='Tehran-Chat').users_online.exclude(id=self.user.id)
        ...
        html = render_to_string("chichat/partials/online_status.html", context=context)
        self.send(text_data=html) 